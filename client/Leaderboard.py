...
class Leaderboard:
    def __init__(self, display, gameStateManager):
        ...
        self.rect_rank_user = pygame.Rect(
            (Game.SCREEN_WIDTH)/2-110, 530, 40, 40)
        ...
        self.rect_score_user = pygame.Rect(
            (Game.SCREEN_WIDTH)/2+50, 530, 70, 40)
        ...
        self.title_leaderboard = title_font.render(
